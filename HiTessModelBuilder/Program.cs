...
namespace HiTessModelBuilder
{
  ...
  public class MainApp
  {
    ...
    /// <summary>
    /// Launcher GUI에서 호출하는 핵심 파이프라인 엔진 입구입니다.
    /// </summary>
    public static void RunApplication(AppOptions opt)
    {
      // ====================================================================
      // ★ [신규 추가] 사용 기한 제한 (Time-Bomb) 로직
      // ====================================================================
      DateTime expirationDate = new DateTime(2026, 4, 30); // 만료일 설정 (필요시 수정)
      if (DateTime.Now > expirationDate)
      {
        // Launcher에서 이 예외를 Catch하여 경고창(MessageBox)을 띄우게 됩니다.
        throw new TimeoutException("베타 테스트 기간이 만료되었습니다.\n설계부 담당자에게 최신 버전을 요청해 주세요.");
      }
      // ====================================================================
