...
namespace HiTessModelBuilder.Services.Builders
{
  public class PipeModelBuilder
  {
    ...
    public void Build(List<PipeEntity> pipeList)
    {
      ...
      {
        bool isMassValid = double.TryParse(pipeData.Mass, System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out double rawMassValue);
        double massValue = rawMassValue * 0.001;
